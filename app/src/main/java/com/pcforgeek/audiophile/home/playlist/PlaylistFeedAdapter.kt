...
class PlaylistFeedAdapter(private val playList: MutableList<Playlist>, private val listener: OnClick) :
    ...
    fun addData(data: List<Playlist>) {
        playList.clear()
    ...
    interface OnClick {
        fun playlistClicked(playlist: Playlist, browsable: Boolean = false)
    }
}
