package dev.joeljacob.audiophile.notifcation
...
const val NOW_PLAYING_CHANNEL: String = "dev.joeljacob.audiophy.service.media.NOW_PLAYING"
...
class NotificationBuilder(private val context: Context) {
    ...
    fun buildNotification(
        ...
        // Shows up to 5 icons for actions when expanded, and up to 3 icons (on the right hand side) when
        // collapsed.
        // setShowActionsInCompactView() takes indices of the actions added to the notification builder.
        // It can only be used with MediaStyle
        ...
        if (metadata.albumArtUri?.encodedPath != null)
            return notificationBuilder
                .setLargeIcon(BitmapFactory.decodeFile(metadata.albumArtUri?.encodedPath))
                .build()
